...
// Dropbox OAuth Login URL
const authorize = () => {
  const url = `https://www.dropbox.com/oauth2/authorize?client_id=${clientId.value}&redirect_uri=${redirectUri}&response_type=token`;
  if(!clientId.value) {
...
// Check for access token in the URL and update the state
onMounted(() => {
...
<template>
  <div class="min-h-screen flex items-center justify-center">
    <div class="container mx-auto p-4">
      ...
      <button @click="authorize" class="my-4 px-6 py-3 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600">Authorize with Dropbox</button>
      <div class="mb-4">
